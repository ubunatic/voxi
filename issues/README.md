...
| 050 | [050-optional-warm-model-daemon-transcription.md](050-optional-warm-model-daemon-transcription.md) | 050: Optional Warm-Model / Daemon-Mode Transcription (Avoid Per-Utterance GPU Reload) | Investigated — No Viable Mechanism (closed without code changes) |
